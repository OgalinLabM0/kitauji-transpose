...
const NAMESPACES = {
  ...
  project: ['listImportQueues', 'listDamagedImportQueues', 'quarantineImportQueue', 'createImportQueue', 'updateImportQueue', 'discardImportQueue', 'inspectQueuedFile', 'importNextQueuedFile', 'listSeries', 'getSeries', 'deleteSeries', 'inspectImport', 'cancelImport', 'importFile', 'listVolumes', 'listChapters', 'rebuildEpubChapters', 'listParagraphs', 'listParagraphsByVolume', 'getParagraph', 'getSettings', 'setSetting', 'prepStatus', 'analysis'],
