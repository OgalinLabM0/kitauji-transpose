...
const NAMESPACES = {
  ...
  review: ['assistant', 'list', 'counts', 'decide', 'resolveHonorific', 'undoResolved', 'previewLegacyChange', 'reconfirmLegacyChange', 'undoLegacyReconfirmation', 'setPreselect', 'aiReview', 'runScoped'],
